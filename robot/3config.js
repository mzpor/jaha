...
const WORKSHOP_CONFIG = {
  ...
  REQUIRED_FIELDS: {
    ...
    REGION: 1,             // پهنه راهبر - اجباری
    PROVINCE: 1            // استان راهبر - اجباری
  },
  ...
  FIELD_DISPLAY_NAMES: {
    ...
    REGION: 'پهنه راهبر',            // پهنه راهبر
    PROVINCE: 'استان راهبر'          // استان راهبر
  },
...
const ROBOT_BUTTON_BY_ROLE = {
  SCHOOL_ADMIN: 0,    // مدیر: 1 = نمایش، 0 = مخفی
...
const MAIN_BUTTONS_CONFIG = {
  ...
  REGISTER_INFO_BY_ROLE: {
    SCHOOL_ADMIN: 0,    // مدیر راهبران: 1 = نمایش، 0 = مخفی
    COACH: 0,           // راهبر: 1 = نمایش، 0 = مخفی
    ASSISTANT: 0,       // دبیر: 1 = نمایش، 0 = مخفی
    STUDENT: 0          // فعال: 1 = نمایش، 0 = مخفی
  },
