...
// ===== کانفیگ کارگاه‌ها =====
// 💡 نکته: برای تغییر نام‌های ظاهری، کافی است مقادیر زیر را تغییر دهید
// WORKSHOP_DISPLAY_NAME: نام کارگاه در پنل مدیر
// DISPLAY_NAMES: نام‌های قابل تغییر برای هماهنگی با کانفیگ نقش‌ها
const WORKSHOP_CONFIG = {
  // نام ظاهری کارگاه - قابل تغییر برای هماهنگی با کانفیگ نقش‌ها
  WORKSHOP_DISPLAY_NAME: 'راهبران',     // کارگاه - استفاده از COACH برای هماهنگی با کانفیگ نقش‌ها
  
  // فیلدهای اجباری/اختیاری (0 = اختیاری، 1 = اجباری)
  REQUIRED_FIELDS: {
    INSTRUCTOR_NAME: 1,    // نام مربی - اجباری
    PHONE: 0,              // تلفن - اختیاری  
    COST: 0,               // هزینه (منطقه) - موقتاً غیرفعال (0 = اختیاری)
  ...
  FIELD_DISPLAY_NAMES: {
    ...
    COST: 'منطقه',                   // هزینه - تغییر یافته به منطقه
    LINK: 'منطقه'                // لینک گروه - تغییر یافته به منطقه
  ...
  // کانفیگ نام‌های قابل تغییر - برای هماهنگی با کانفیگ نقش‌ها
  DISPLAY_NAMES: {
